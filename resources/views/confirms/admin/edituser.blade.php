...
<div class="container-fluid">
    <div class="row">
        ...
        <form action="/admin/member/{{$user['id']}}/update " method="POST" enctype="multipart/form-data" align="center">
            @csrf

            <div class="form-group">
                <label for="photo">Change Member Image</label>
                <div>
            ...
            <div class="form-group">
                <label for="dob">Member Birthday</label>
                <div>{{$user['dob']}}</div>
            </div>

            <div class="form-group">
                <label for="number">Member Phone Number</label>
                <div>{{$user['number']}}</div>
            </div>

            <div class="form-group">
                <label for="role" class="col-md-4 control-label">Member Type:</label>
                <div>{{$user['role']}}</div>
            </div>
